...
import com.location.alerts.Alerts;
    ...
    private class AddressResultReceiver extends ResultReceiver {
        ...
        protected void onReceiveResult(int resultCode, Bundle resultData) {
            ...
            if (resultCode == Constants.SUCCESS_RESULT) {
                ...
                double latitude = resultData.getDouble(Constants.RESULT_LATITUDE);
                double longitude = resultData.getDouble(Constants.RESULT_LONGITUDE);
//                String maxAddress, String pin, String state, String city, String subCity, String countryCode
                if(locationListener != null) {
                    locationListener.locationReceived(mAddressOutput, pin, state, city, subCity, countryCode, latitude, longitude);
                }
