...
import com.location.utils.Constants;
...
//            address.getAddressLine(0) = 149, 9th A Cross Rd, Jeewan Sathi Colony, 1st Phase, JP Nagar, Bengaluru, Karnataka 560078, India
            ...
            deliverResultToReceiver(Constants.SUCCESS_RESULT,
                    ...
                    address.getAdminArea(), address.getLocality(), address.getSubAdminArea(),
                    address.getCountryCode(), location.getLatitude(), location.getLongitude());
        }
    }
     ...
     */
    private void deliverResultToReceiver(int resultCode, String maxAddress, String pin, String state, String city, String subCity,
                                         String countryCode, double latitude, double longitude) {
        Bundle bundle = new Bundle();
        bundle.putString(Constants.RESULT_MAX_ADDRESS_KEY, maxAddress);
        bundle.putString(Constants.RESULT_PIN_KEY, pin);
        bundle.putString(Constants.RESULT_ADMIN_AREA_KEY, state);
